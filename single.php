		...
		<div class="col-md-8 col-md-offset-2 col-xs-12">
			<div class="mainheading">
				...
				<div class="row post-top-meta">
					<div class="col-md-2">
						<a href="author.html"><img class="author-thumb" src="<?php echo get_the_author_meta( 'userpicprofile' ) ?>"alt="Sal"></a>
					</div>
					<div class="col-md-10">
						<a class="link-dark" href="<?php echo get_author_posts_url(get_the_author_meta( 'ID' )) ?>"> <?php echo get_the_author_meta('first_name') ?> </a><a href="#" class="btn follow">Follow</a>
						<span class="author-description"> <?php echo get_the_author_meta('user_description') ?>  </span>
			...
			<img class="featured-image img-fluid" src="<?php echo get_the_post_thumbnail_url() ?>" alt="">
			<!-- End Featured Image -->
